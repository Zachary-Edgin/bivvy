// Inline dependencies (no external imports needed in electron main process)

function parseTypeStyle(value: string): { fontSize: string; lineHeight: string; fontWeight: string; fontFamily: string } | null {
...
// Component library is optional in the electron context — patterns section will be empty
const componentLibrary: { name: string; category: string }[] = [];
